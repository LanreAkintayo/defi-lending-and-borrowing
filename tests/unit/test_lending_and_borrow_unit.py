...
def test_lending():
    ...
    no_of_tokens_lent = lending_and_borrowing.noOfTokensLent()

    hasLent = lending_and_borrowing.hasLentOrBorrowedToken(account, lar_token, no_of_tokens_lent, "tokensLent")

    assert bool(hasLent) == True
    ...
    print("Here account can borrow ", availableToBorrowInDollars)
    ...
    availableToBorrowInDollars = lending_and_borrowing.getUserTotalAmountAvailableForBorrowInDollars(account)
    print("Now, account can borrow: ", availableToBorrowInDollars)
    ...
    assert lending_and_borrowing.tokensLentAmount(lar_token, account) == amount * 2
